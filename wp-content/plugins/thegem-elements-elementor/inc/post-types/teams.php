...
function thegem_team_person_custom_fields_box($post) {
	...
	if(!empty($team_persons_custom_fields) && is_array($team_persons_custom_fields)) {
		...
		printf(__('You can add more custom fields via <a target="_blank" href="%s">Theme Option</a>', 'thegem'), admin_url('admin.php?page=thegem-theme-options#/posttypes/team_persons'));
	} else {
