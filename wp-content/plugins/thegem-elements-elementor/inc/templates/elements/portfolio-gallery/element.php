...
class TheGem_TemplatePortfolioGallery extends Widget_Base {
	...
	public function render() {
		...
		if (!empty($params['arrows_icons']) && $params['arrows_icons'] == 'custom' && !empty($params['arrows_prev_icon_select']['value'])) {
			...
			$carousel_nav_prev .= '<a href="javascript:void(0);" class="icon" role="button" aria-label="' . esc_attr__('Prev', 'thegem') . '">'.ob_get_clean().'</a>';
		} else if (!empty($params['arrows_icons']) && $params['arrows_icons'] == 'default') {
			$carousel_nav_prev .= '<a href="javascript:void(0);" class="icon" role="button" aria-label="' . esc_attr__('Prev', 'thegem') . '"><i class="icon-default"></i></a>';
		}
		...
		if (!empty($params['arrows_icons']) && $params['arrows_icons'] == 'custom' && !empty($params['arrows_next_icon_select']['value'])) {
			...
			$carousel_nav_next = '<a href="javascript:void(0);" class="icon" role="button" aria-label="' . esc_attr__('Next', 'thegem') . '">'.ob_get_clean().'</a>';
		} else if (!empty($params['arrows_icons']) && $params['arrows_icons'] == 'default') {
			$carousel_nav_next = '<a href="javascript:void(0);" class="icon" role="button" aria-label="' . esc_attr__('Next', 'thegem') . '"><i class="icon-default"></i></a>';
		}
