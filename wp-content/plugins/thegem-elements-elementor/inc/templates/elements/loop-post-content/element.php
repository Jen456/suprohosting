...
class TheGem_TemplateLoopPostContent extends Widget_Base {
	...
	public function render() {
		...
		if($params['truncate_content'] != -1 && ($params['truncate_content'] < 1 || $params['truncate_content'] > 100)) {
		...
		if($params['truncate_content'] != -1) {
			$content = wp_trim_words($content, $params['truncate_content']);
		} else {
