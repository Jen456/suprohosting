...
namespace TheGem_Elementor\Widgets\TemplateLoopProductRating;
...
class TheGem_TemplateLoopProductRating extends Widget_Base {
	...
	public function get_name() {
		return 'thegem-template-loop-product-rating';
	}
	...
	public function get_widget_wrapper() {
		return 'thegem-te-loop-product-rating';
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .product-rating' => 'gap: {{SIZE}}{{UNIT}};',
				],
				'condition' => [
					'show_counts' => 'yes'
				]
		...
		$this->add_group_control(
			...
			[
				'name' => 'typography',
				'selector' => '{{WRAPPER}}'.$this->get_customize_class().' .rating-counts',
				'condition' => [
					'show_counts' => 'yes'
				]
			]
		...
		<div <?php if (!empty($params['element_id'])): ?>id="<?=esc_attr($params['element_id']); ?>"<?php endif;?>
			...
			<div class="product-rating">
				...
				<?php if ($params['show_counts']) : ?>
					<div class="rating-counts small-body"><?php printf( __( '(%s)', 'thegem' ), $review_count ); ?></div>
				<?php endif ?>
			</div>
		</div>
...
if(defined('WC_PLUGIN_FILE')) {
	\Elementor\Plugin::instance()->widgets_manager->register(new TheGem_TemplateLoopProductRating());
}