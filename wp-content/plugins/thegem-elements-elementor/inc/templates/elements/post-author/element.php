            ...
            <div class="post-author">
                ...
                <?php if ( !empty($params['author_link']) && get_the_author_meta('url', $user_id) ) : ?>
                    <a href="<?= esc_url( get_the_author_meta('url', $user_id) ); ?>" class="post-author__avatar" <?php if (!empty($style)) : ?>style="<?=$style?>"<?php endif; ?>>
				        <?= get_avatar( $user_id, $size, '', get_the_author() ); ?>
                    </a>
		        <?php else : ?>
                    <div class="post-author__avatar" <?php if (!empty($style)) : ?>style="<?=$style?>"<?php endif; ?>><?= get_avatar( $user_id, $size, '', get_the_author() ); ?></div>
		        <?php endif; ?>
		        <?php endif; ?>
