...
class TheGem_TemplatePostNavigation extends Widget_Base {
	...
	public function render() {
		...
		$prev_text_output .= !empty($params['label']) || !empty($params['title']) ? '<span class="meta-nav" aria-hidden="true">' : '<span class="screen-reader-text">' . esc_html__('Prev', 'thegem') . '</span>';
		...
		$next_text_output .= !empty($params['label']) || !empty($params['title']) ? '<span class="meta-nav" aria-hidden="true">' : '<span class="screen-reader-text">' . esc_html__('Next', 'thegem') . '</span>';
