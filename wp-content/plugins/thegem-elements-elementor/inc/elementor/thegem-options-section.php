...
class TheGem_Options_Section {
	...
	public function __construct() {
		...
		//add_action('elementor/element/container/_section_responsive/after_section_end', array($this, 'add_container_thegem_options_section'), 10, 2);
		add_action('elementor/element/container/thegem_options/before_section_end', array($this, 'add_container_thegem_options_section'), 10, 2);
	...
	public function add_container_thegem_options_section($element, $args) {

		/*$element->start_controls_section(
			'container_thegem_options',
			array(
				'label' => esc_html__('TheGem Options', 'thegem'),
				'tab' => Controls_Manager::TAB_ADVANCED,
			)
		...
		$element->add_responsive_control(
			'container_column_sticky',
			[
				'label' => esc_html__('Sticky', 'thegem'),
				'type' => Controls_Manager::SWITCHER,
				'label_on' => __('Yes', 'thegem'),
				'label_off' => __('No', 'thegem'),
				'default' => '',
				'prefix_class' => 'thegem-e-con-sticky%s-',
		...
		$element->add_control(
			...
			[
				...
				'prefix_class' => 'thegem-e-con-sticky-position-',
				'condition' => [
					'container_column_sticky' => 'yes',
				]
			]
		);

		$element->add_responsive_control(
			'container_column_sticky_offset',
			[
				...
				'selectors' => [
					'{{WRAPPER}}' => '--thegem-sticky-offset: {{SIZE}}{{UNIT}}',
				],
			]
		);
	...
	public function generate_breakpoint_css($selector, $breakpoint = array()) {
		...
		if ($column_visibility) {
			...
			if ( version_compare( ELEMENTOR_VERSION, '3.19.0', '>=' ) ) {
				$css .= !empty($dimensions_css_padding) ? $selector . ' > .elementor-element-populated{' . $dimensions_css_padding . '}' : '';
			} else {
	...
	public function section_before_render($element) {
		if ('section' === $element->get_name()) {
			...
			if(!empty($settings['background_video_fallback'])) {
