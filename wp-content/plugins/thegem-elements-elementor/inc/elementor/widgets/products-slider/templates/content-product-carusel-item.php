...
<div <?php post_class($thegem_classes); ?>
	...
	<div class="wrap clearfix">
		<div <?php post_class($thegem_image_classes); ?>>
			...
			<div class="overlay">
							...
							<div class="portfolio-icons product-bottom">
								<div class="portfolio-icons-inner clearfix">
									...
									<a href="<?= esc_url(get_the_permalink()); ?>"
									   ...
									   aria-label="<?php echo $product->get_name(); ?>">
									...
									<?php if ($settings['social_sharing'] == 'yes'): ?>
										<a href="javascript: void(0);" role="button" class="icon share" aria-label="<?php esc_attr_e('Share', 'thegem'); ?>">
				...
				<?php if ($settings['caption_position'] == 'page'): ?>
					<a href="<?php echo get_permalink(); ?>" aria-label="<?php echo $product->get_name(); ?>"></a>
				<?php endif; ?>
			</div>
		</div>
		<?php if ($settings['caption_position'] == 'page'): ?>
					...
					<div class="product-bottom clearfix">
						...
						<?php if ($settings['social_sharing'] == 'yes'): ?>
							<div class="post-footer-sharing">
								<a href="javascript: void(0);" role="button" class="icon share bottom-product-link" aria-label="<?php esc_attr_e('Share', 'thegem'); ?>">
									<?php if ($settings['hover_icon_share']['value']) {
										Icons_Manager::render_icon($settings['hover_icon_share'], ['aria-hidden' => 'true']);
									} else { ?>
										<i class="default"></i>
		...
		<div class="product-labels">
			...
			<?php endif; ?>
			<?php if ($settings['products_show_new_label'] == 'yes' && function_exists('thegem_product_need_new_label') && thegem_product_need_new_label($product->get_id())) : ?>
