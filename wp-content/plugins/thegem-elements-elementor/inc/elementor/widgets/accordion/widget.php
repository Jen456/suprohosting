...
class TheGem_Accordion extends Widget_Base
{
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'active_section',
			[
				'label' => __('Active Section', 'thegem'),
				'default' => '',
	...
	public function render()
	{
		...
		$active_section = isset($settings['active_section']) && intval($settings['active_section']) > 1 ? intval($settings['active_section']) : 1;
				...
				<div class="gem-tta-panels-container">
					<div class="gem-tta-panels">
						<?php foreach ( $settings['tabs'] as $index => $item ) :
							...
							$section_id = esc_attr(! empty( $item['section_id']) ? $item['section_id'] : 'section-' . $id_str . '-' . $count);

							$this->add_render_attribute( $title_setting_key, [
								'id' => $section_id,
								'class' => [ 'gem-tta-panel', ((!$is_close_all_sections && $index === $active_section - 1) ? 'gem-tta-active' : '') ],
