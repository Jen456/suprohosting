									...
									<?php if ($settings['portfolio_show_filter'] == 'yes' && count($terms) > 0): ?>
										<div class="portfolio-filters">
											...
											<?php foreach ($terms as $term) : ?>
												<a href="#" role="button" data-filter=".<?php echo $term->slug; ?>"
									...
									<?php if ($settings['portfolio_show_sorting'] == 'yes'): ?>
										<div class="portfolio-sorting title-h6">
											<div class="orderby light">
												...
												<a href="javascript:void(0);" role="button" class="sorting-switcher"
												   data-current="date" aria-label="<?php esc_attr_e('Order by', 'thegem'); ?>"></a>
												<label for=""
											...
											<div class="order light">
												...
												<a href="javascript:void(0);" class="sorting-switcher"
												   data-current="DESC" aria-label="<?php esc_attr_e('Order', 'thegem'); ?>"></a>
												<label for=""
