...
class TheGem_Custom_Menu extends Widget_Base {
	...
	protected function register_controls() {
		...
		$this->add_control(
			'submenu_onhover',
			[
				'label' => __('Show Submenu Items (On hover)', 'thegem'),
				'type' => Controls_Manager::SWITCHER,
				'default' => 'no',
				'return_value' => 'yes',
				'label_on' => __('On', 'thegem'),
	...
	protected function menu_style($control) {
		...
		$control->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em', 'rem', 'vw' ],
				'selectors' => [
					'{{WRAPPER}} ul.nav-menu-custom li a' => 'margin-left: {{LEFT}}{{UNIT}} !important; margin-right: {{RIGHT}}{{UNIT}} !important; margin-top: {{TOP}}{{UNIT}} !important; margin-bottom: {{BOTTOM}}{{UNIT}} !important;',
				],
			]
		);
		...
		$control->start_controls_tabs('tabs_submenu_style');
		$control->start_controls_tab(
		...
		$control->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} ul.nav-menu-custom ul li a,
					{{WRAPPER}} ul.nav-menu-custom ul li > span' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'submenu_style' => 'horizontal'
				],
		...
		$control->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} ul.nav-menu-custom ul li a,
					{{WRAPPER}} ul.nav-menu-custom ul li > span' => 'background-color: {{VALUE}} !important;',
				],
				'condition' => [
					'submenu_style' => 'horizontal'
				],
		...
		$control->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} ul.nav-menu-custom ul,
					{{WRAPPER}} ul.nav-menu-custom ul li' => 'border-color: {{VALUE}} !important;',
				],
				'condition' => [
					'submenu_style' => 'horizontal'
				],
		...
		$control->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} ul.nav-menu-custom ul li:hover > a,
					{{WRAPPER}} ul.nav-menu-custom ul li:hover > span' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'submenu_style' => 'horizontal'
				],
		...
		$control->add_control(
			'submenu_item_background_hover',
			[
				'label' => __('Background Color', 'thegem'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} ul.nav-menu-custom ul li:hover > a:before,
					{{WRAPPER}} ul.nav-menu-custom ul li:hover > span' => 'background-color: {{VALUE}} !important;',
				],
				'condition' => [
					'submenu_style' => 'horizontal'
				],
		...
		$control->add_control(
			'submenu_item_color_active',
			[
				'label' => __('Text Color', 'thegem'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} ul.nav-menu-custom ul li.menu-item-current > a,
					{{WRAPPER}} ul.nav-menu-custom ul li.menu-item-current > span,
					{{WRAPPER}} ul.nav-menu-custom ul li.menu-item-active > a,
					{{WRAPPER}} ul.nav-menu-custom ul li.menu-item-active > span' => 'color: {{VALUE}} !important;',
				],
				'condition' => [
					'submenu_style' => 'horizontal'
				],
		...
		$control->add_control(
			'submenu_item_background_active',
			[
				'label' => __('Background Color', 'thegem'),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} ul.nav-menu-custom ul li.menu-item-current > a:before,
					{{WRAPPER}} ul.nav-menu-custom ul li.menu-item-current > span,
					{{WRAPPER}} ul.nav-menu-custom ul li.menu-item-active > a:before,
					{{WRAPPER}} ul.nav-menu-custom ul li.menu-item-active > span' => 'background-color: {{VALUE}} !important;',
				],
				'condition' => [
					'submenu_style' => 'horizontal'
				],
	...
	public function render() {
		...
		if($settings['submenu_onhover'] == 'yes') {
			$this->add_render_attribute( 'menu-wrap', 'class', ['thegem-menu-custom--dropdown']);
		}
		...
		<div <?php echo $this->get_render_attribute_string( 'menu-wrap' ); ?>>
			...
			if ($settings['menu_source'] == 'nav_menu') {
				if (!empty($settings['nav_menu']) && is_nav_menu($settings['nav_menu']) && !empty(wp_get_nav_menu_items($settings['nav_menu']))) {
					if (!empty($settings['show_submenus']) || $settings['submenu_onclick'] === 'yes' || $settings['submenu_onhover'] === 'yes') {
						$depth = 0;
					} else {
						$depth = 1;
					}
					...
					echo '<div role="navigation" aria-label="' . esc_attr($uniqid) . '">';
					wp_nav_menu(array(
						'menu' => $settings['nav_menu'],
						'menu_class' => 'nav-menu-custom scroll-to-anchor',
						'container' => null,
						'echo' => true,
						'depth' => $depth,
				...
				if (!empty($menu_custom)) {
					echo '<div role="navigation" aria-label="' . esc_attr($uniqid) . '"><ul class="nav-menu-custom scroll-to-anchor">';
