				...
				<div class="team-person-email">
					<?php if ( $thegem_item_data['hide_email']) :
						...
						if(count($hidden_email) == 2) :
							echo '<a href="#" class="hidden-email" data-name="'.$hidden_email[0].'" data-domain="'.$hidden_email[1].'" aria-label="Email"></a>';
						endif;
					else : ?>
						<a href="mailto:<?php echo esc_attr( $thegem_item_data['email'] ); ?>" aria-label="Email"></a>
					<?php endif; ?>
				</div>
			<?php endif; ?>
