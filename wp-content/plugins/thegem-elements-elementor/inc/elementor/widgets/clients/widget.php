...
class TheGem_Clients extends Widget_Base {
	...
	protected function container_styles( $control ) {
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => true,
				'selectors' => [
					'{{WRAPPER}} .gem-client-item a, {{WRAPPER}} .gem-client-item span' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gem-clients-type-carousel-grid  .gem-client-item a, {{WRAPPER}} .gem-clients-type-carousel-grid  .gem-client-item span' => 'height:{{SIZE}}{{UNIT}};max-height:100%;',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .gem-clients-type-carousel-grid .gem-client-item a, {{WRAPPER}} .gem-clients-type-carousel-grid .gem-client-item span' => 'width:calc(100% - {{SIZE}}{{UNIT}}); margin:0px 0px {{SIZE}}{{UNIT}} 0px;',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .gem-client-item a, {{WRAPPER}} .gem-client-item span',
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .gem-client-item a, {{WRAPPER}} .gem-client-item span' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$control->add_responsive_control(
			...
			[
				...
				'label_block' => false,
				'selectors' => [
					'{{WRAPPER}} .gem-client-item a:hover, {{WRAPPER}} .gem-client-item span:hover' => 'background-color: {{VALUE}};',
				],
			]
		);
		...
		$control->add_group_control(
			...
			[
				...
				'label' => __('Border', 'thegem'),
				'selector' => '{{WRAPPER}} .gem-client-item a:hover, {{WRAPPER}} .gem-client-item span:hover',
	...
	public function render() {
		...
		$presets = array_keys($this->get_presets_options());
		$default_preset = $this->set_default_presets_options();
		if(!in_array($settings['thegem_elementor_preset'], $presets)) {
			$settings['thegem_elementor_preset'] = $default_preset;
		}
