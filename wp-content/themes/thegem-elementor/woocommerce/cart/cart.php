	...
	<div class="gem-table"><table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
		<thead>
			<tr>
				...
				<th scope="col" class="product-name" colspan="<?php echo ($thegem_cart_layout == 'modern' ? '3' : '2');?>"><?php esc_html_e( 'Product', 'woocommerce' ); ?></th>
				<?php if($thegem_cart_layout != 'modern') : ?><th scope="col" class="product-price"><?php esc_html_e( 'Price', 'woocommerce' ); ?></th><?php endif; ?>
