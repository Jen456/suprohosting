...
<form class="checkout_coupon woocommerce-form-coupon" method="post"<?php echo ($thegem_use_template ? '' : ' style="display:none"'); ?> id="woocommerce-checkout-form-coupon">
