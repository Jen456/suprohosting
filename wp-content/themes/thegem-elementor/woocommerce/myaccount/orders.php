		...
		<thead>
			<tr>
				<?php foreach ( wc_get_account_orders_columns() as $column_id => $column_name ) : ?>
					<th scope="col" class="woocommerce-orders-table__header woocommerce-orders-table__header-<?php echo esc_attr( $column_id ); ?>"><h6><span class="nobr"><?php echo esc_html( $column_name ); ?></span></h6></th>
				<?php endforeach; ?>
			</tr>
		</thead>
